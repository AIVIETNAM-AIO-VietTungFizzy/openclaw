...
export type SkillsInstallFromRCParams = SchemaType<"SkillsInstallFromRCParams">;
export type SkillsUninstallFromRCParams = SchemaType<"SkillsUninstallFromRCParams">;
